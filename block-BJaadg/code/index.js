...
quote.charAt(quote.indexOfIs('is'))

/*
3. Log the message saying `The index of first is in quote is 7`
*/

console.log(`The index of first is in quote is ${quote.charAt(quote.indexOfIs('is'))}`)
...
for (let i = 0 ; i <= 5 ; i ++)
  console.log(` The character at index ${} is ${quote[i]}`)
...
let newQuote = quote + "." .repeat(max - length) + quote ;

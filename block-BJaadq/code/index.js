...
function peopleByHouses() {
  // your code goes here
  let obj = {};
  got.houses.forEach((value) => {
    obj[value.name] = value.people.length;
  });
  return obj;
}
...
function peopleNameOfAllHouses() {
  let final = {};
  got.houses.forEach((house)  => { final[house.name] = house.people.map((p) => p.name)

...
function doubleNumbers(p){
    return p*2;
}
let num3Array = numbersThree.flat(Infinity);
num3Array.map(doubleNumbers);
...
let tripleNumbers = numbersThree.flat(Infinity);

tripleNumbers.map((i) => i * 2);
...
let halfNumbers = numbersThree.flat(Infinity);

halfNumbers.map((i) => i / 2);
...
let oddNumbers = numbersThree.flat(Infinity);

oddNumbers.filter((i) => i % 2 !== 0)
